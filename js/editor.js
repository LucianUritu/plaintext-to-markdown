export function getEditorElements() {
  return {
    ...
    chapterCitationTools: document.getElementById("chapterCitationTools"),
    citationReferenceSelect: document.getElementById("citationReferenceSelect"),
    insertCitationButton: document.getElementById("insertCitationButton"),
    chapterBibliographyPanel: document.getElementById("chapterBibliographyPanel"),
    chapterBibliographyToggle: document.getElementById("chapterBibliographyToggle"),
    chapterReferenceList: document.getElementById("chapterReferenceList"),
    bibliographyManager: document.getElementById("bibliographyManager"),
    referenceCount: document.getElementById("referenceCount"),
    referenceForm: document.getElementById("referenceForm"),
    referenceIdInput: document.getElementById("referenceIdInput"),
    referenceAuthorsInput: document.getElementById("referenceAuthorsInput"),
    referenceTitleInput: document.getElementById("referenceTitleInput"),
    referenceYearInput: document.getElementById("referenceYearInput"),
    referenceUrlInput: document.getElementById("referenceUrlInput"),
    saveReferenceButton: document.getElementById("saveReferenceButton"),
    cancelReferenceEditButton: document.getElementById("cancelReferenceEditButton"),
